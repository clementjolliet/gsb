<div class="container-fluid">
    ...
    <!--index.php?uc=comptableSuiviPaiementFiche&action=voirFicheFrais-->
    <?php
    if ($uc == "comptableValidationFiche" && $_SESSION['fonction'] == "comptable") {
        ?>
        <form action="index.php?uc=comptableValidationFiche&action=affichePageFraisComptable" method="post">
